...
public class AppointmentsController : ControllerBase
{
    ...
    public AppointmentsController(IAppointmentsService appointmentsService) => _appointmentsService = appointmentsService;
    ...
    {
        _appointmentsService.CreateAppointmentAsync(appointmentRequestDTO);
